  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Certificate of Indigency Report</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Indingency_Report</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            ...
            <br>
                <table id="" class="table table-bordered table-striped">
                  ...
                  $d2 = $_GET['d2'];
                      # code...
                      $query = mysqli_query($conn, "SELECT * from application where permit_type = 'Indigency' AND ustatus = 'Approved' order by udate_approve desc ") or die(mysqli_error($conn));
