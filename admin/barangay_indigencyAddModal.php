<div class="modal fade" id="indigencyModal">
      <form method="POST" enctype="multipart/form-data" action="bgyIndigencyAdd.php">
                           ...
                           <div class="col-sm-12">
                             <div class="row">
                              ...
                              <div class="form-group">
                                 ...
                                 <textarea class="form-control" id="Purpose" rows="3" name="purpose" autofocus></textarea>
                              </div>
