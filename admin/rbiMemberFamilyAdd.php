...
if (isset($_POST['btn_tenant']))
{
    ...
    $sql2 = mysqli_query($conn,"INSERT INTO rbi_tenant (rbi_id,  streetno, firstname, middlename, lastname, full_name, birth_place, birth_date, gender, civil_status, occupation, relationship, family_no, voter_status, resident_no, rnumber,status) 
    VALUES('$rbi_id', '$streetno','$fname', '$mname', '$lname','$full_name' ,'$birth_place' ,'$birth_date', '$gender','$civil_status','$occupation','$relation','$family_no', '$voter_status','$residentId', '$residentNo','Active')") or die(mysqli_error($conn));
